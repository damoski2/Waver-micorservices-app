...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect("amqps://ejhxxmkd:ovztyxVMAHiWQBSgoZJMQwUg6vg01Img@jackal.rmq.cloudamqp.com/ejhxxmkd", function (error0, connection) {
        if (error0)
            throw error0;
        connection.createChannel(function (error1, channel) {
            ...
            app.post('/api/products/:id/like', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOneById(req.params.id)];
                        case 1:
                            product = _a.sent();
                            console.log(product);
